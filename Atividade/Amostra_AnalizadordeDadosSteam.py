"""
Dados Esperados (calculados manualmente)

Resultado esperado para os jogos Grátis = 5.88%
Resultado esperado para os jogos Pagos = 94.12%
Ano com maior quantidade de lançamentos = 2021
Jogo mais Caro = Project MIKHAIL: A Muv-Luv War Story por $19.99
...
analisador = AnalisadordeDados('amostras_steam_games.csv')
